<h1 align="center">V1LLSEC - Client</h1>
...
![Badge](https://img.shields.io/static/v1?label=node&message=12.16.3&style=for-the-badge&logo=NODE)
![Badge](https://img.shields.io/static/v1?label=npm&message=6.14.4&style=for-the-badge&logo=NPM)
![Badge](https://img.shields.io/static/v1?label=material&message=10.1.2&style=for-the-badge)
![Badge](https://img.shields.io/static/v1?label=bootstrap&message=4.5.0&style=for-the-badge)
![Badge](https://img.shields.io/static/v1?label=express&message=4.17.1&style=for-the-badge)
![Badge](https://img.shields.io/static/v1?label=swiper&message=5.4.5&style=for-the-badge)
![Badge](https://img.shields.io/static/v1?label=typescript&message=3.9.7&style=for-the-badge&logo=TYPESCRIPT)
![Badge](https://img.shields.io/static/v1?label=angular&message=10&style=for-the-badge&logo=ANGULAR)
...
<h2 align="left">Pré-requisitos</h2>
  ...
  * [typescript](https://spring.io/tools)
...
$ git clone <git@github.com:ederrosa/villsec-frontend-angular.git>
...
```
* [tenha o Backend funcionando](https://github.com/ederrosa/villsec-backend-java)

## Autor
---
<img style="border-radius: 50%;" src="https://github.com/ederrosa.png" width="100px;" alt="EXSR"/>
<br />
